...
import it.unisa.java_music_playlist_manager.model.AutomaticPlaylistByTag;
 ...
 * {@link GenrePlaylistGenerator}, {@link YearPlaylistGenerator},
 * {@link TagPlaylistGenerator}.
 */
public class AutomaticPlaylistGeneratorTest {
        ...
        public void setUp() {
                ...
                trackRock1975 = new Track("Bohemian Rhapsody", "Queen", "A Night at the Opera", 354, "Rock", 1975,
                                "path2.mp3");
        }

        @AfterEach
        public void tearDown() {
                // la Library mantiene il suo stato tra un test e l'altro, quindi svuoto tracce
                // e playlist
        ...
        public void testSetLibraryDependencyInjectionOverrideDefaultFallback() {
                ...
                for (Track t : singleton.getTracks())
                        singleton.removeTrack(t);
                for (Playlist p : singleton.getPlaylists())
                        singleton.removePlaylist(p);
