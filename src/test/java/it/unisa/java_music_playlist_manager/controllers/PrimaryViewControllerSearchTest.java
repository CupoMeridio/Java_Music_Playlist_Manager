...
public class PrimaryViewControllerSearchTest {
    ...
    @BeforeEach
    public void setUp() {
        track1 = new Track("Bohemian Rhapsody", "Queen", "A Night at the Opera", 355, "Rock", 1975,
                "path/to/bohemian.mp3");
        track2 = new Track("Bad Guy", "Billie Eilish", "When We All Fall Asleep", 194, "Pop", 2019,
                "path/to/badguy.mp3");
    ...
    public void testRicercaPerTag() {
        ...
        assertTrue(resultTracks.contains(track1),
                "Dovrebbe trovare la traccia tramite la sotto-stringa del tag 'Energici'");
    ...
    public void testFormatDuration() {
        String result1 = it.unisa.java_music_playlist_manager.utils.TimeFormatUtils.formatDuration(355);
        String result2 = it.unisa.java_music_playlist_manager.utils.TimeFormatUtils.formatDuration(65);
