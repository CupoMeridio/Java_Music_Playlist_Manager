...
import it.unisa.java_music_playlist_manager.ui.TableSortStateMemento;
...
public class PrimaryViewController implements Observer {
    ...
    @FXML
    private ListView<it.unisa.java_music_playlist_manager.ui.QueueViewManager.QueueItem> queueListView;

    public ListView<it.unisa.java_music_playlist_manager.ui.QueueViewManager.QueueItem> getQueueListView() {
        return queueListView;
    }

    private it.unisa.java_music_playlist_manager.ui.QueueViewManager queueViewManager;
    private it.unisa.java_music_playlist_manager.ui.TrackCardGridManager trackCardGridManager;

    private it.unisa.java_music_playlist_manager.ui.PlaybackUICoordinator playbackCoordinator;
    private it.unisa.java_music_playlist_manager.ui.LibraryActionsHandler libraryActionsHandler;
    private it.unisa.java_music_playlist_manager.ui.ViewNavigationController viewNavigationController;
    ...
    public void initialize() {
        ...
        viewNavigationController = new it.unisa.java_music_playlist_manager.ui.ViewNavigationController(
        ...
        playbackCoordinator = new it.unisa.java_music_playlist_manager.ui.PlaybackUICoordinator(
        ...
        libraryActionsHandler = new it.unisa.java_music_playlist_manager.ui.LibraryActionsHandler(
                dialogService,
                () -> viewNavigationController.getCurrentViewType(),
                () -> viewNavigationController.getCurrentOpenedPlaylist(),
        ...
        queueViewManager = new it.unisa.java_music_playlist_manager.ui.QueueViewManager(queueListView, () -> {
        ...
        trackCardGridManager = new it.unisa.java_music_playlist_manager.ui.TrackCardGridManager(
                trackCardGridView,
                trackTableView,
    ...
    private void showSongsColumns() {
        ...
        List<TableColumn<Track, ?>> columns = it.unisa.java_music_playlist_manager.ui.TableColumnFactory
    ...
    private void showPlaylistColumns() {
        ...
        List<TableColumn<Playlist, ?>> columns = it.unisa.java_music_playlist_manager.ui.TableColumnFactory
    ...
    private void handleActionBtnClick() {
        if (viewNavigationController != null && viewNavigationController.getCurrentViewType() == ViewType.MUSIC) {
            ...
            multiItem.setOnAction(e -> new it.unisa.java_music_playlist_manager.ui.TrackImportController(
                    actionButton.getScene().getWindow()).handleAddFiles());

            MenuItem folderItem = new MenuItem("Aggiungi intera cartella...");
            folderItem.setOnAction(e -> new it.unisa.java_music_playlist_manager.ui.TrackImportController(
