...
/**
 * L'interfaccia PlaybackStrategy definisce il contratto per le strategie di
 * avanzamento nella coda.
 * È la componente base del Pattern Strategy utilizzato nel PlaybackManager.
 * 
 * Permette di cambiare a runtime il comportamento del lettore quando una
 * traccia
 * o un elemento della coda termina, decidendo quale sarà il prossimo indice da
 * riprodurre.
 */
public interface PlaybackStrategy {
     ...
     * @return L'indice del prossimo elemento, oppure un valore fuori range (es.
     *         queueSize)
    ...
    /**
     * Calcola l'indice della prossima traccia all'interno dell'elemento Playable
     * corrente.
