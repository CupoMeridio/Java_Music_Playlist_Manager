 ...
 * In questa modalità, una volta terminata la traccia corrente (anche all'interno
 * di una playlist), il lettore ricomincia a riprodurre la stessa traccia dall'inizio.
 */
